...
namespace MoeLoaderP.Core
{
    ...
    public class Settings : BindingObject
    {
        ...
        public void Save()
        {
            ...
            File.WriteAllText(Extend.SettingJsonFilePath, json);
        }
        ...
        public static Settings Load()
        {
            ...
            try
            {
                if (File.Exists(Extend.SettingJsonFilePath))
                {
                    var json = File.ReadAllText(Extend.SettingJsonFilePath);
            ...
            {
                Extend.ShowMessage("设置读取失败，将读取默认设置");
                Extend.Log(ex);
                settings = new Settings();
            }
            return settings;
